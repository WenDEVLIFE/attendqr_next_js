            ...
            <div className="p-8 flex items-center gap-3">
                <div className="relative w-12 h-12">
                    <Image
                        ...
                        fill
                        sizes="48px"
                        className="object-contain rounded-xl shadow-lg shadow-blue-500/10"
                    />
                </div>
                <div className="flex flex-col">
                    <span className="text-2xl font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-teal-400">
                        AttendQR
                    </span>
                    <span className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-bold -mt-1 ml-0.5">
                        Administration
                    </span>
                </div>
            </div>
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className={`relative z-10 transition-colors duration-300 ${isSelected
                                ? 'text-emerald-500'
                            ...
                            <span className={`relative z-10 text-sm font-semibold tracking-tight transition-colors duration-300 ${isSelected
                                ? 'text-emerald-500'
                                : 'text-zinc-500 group-hover:text-zinc-900 dark:text-zinc-400 dark:group-hover:text-zinc-100'
                                }`}>
                                {item.label}
                            ...
                            {/* Hover Indicator */}
                            {!isSelected && (
                                <div className="absolute left-0 w-1 h-0 bg-emerald-500 group-hover:h-6 transition-all duration-300 rounded-r-full" />
                            )}
                        </button>
                    );
                })}
